            ...
            <ul className="mt-4 space-y-3">
              <li>
                <a
                  ...
                  className="flex items-center justify-center sm:justify-start gap-2 text-sm text-gray-300 transition-colors hover:text-white"
                >
              ...
              <li>
                ...
                >
                  ...
                  {siteConfig.phoneLandline} (Landline)
                </a>
              </li>
              <li>
                <a
